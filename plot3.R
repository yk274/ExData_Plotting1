...
#png3
png(filename = "plot3.png", width = 480, height = 480, units = "px", pointsize = 12, bg = "white", res = NA, type = "quartz")
par(pch=22)
...
legend("topright",NULL , c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), cex=0.8, 
